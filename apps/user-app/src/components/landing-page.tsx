...
import { ArrowRight, Wallet, Shield, Smartphone, CreditCard, Users, Zap } from 'lucide-react'
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="md:flex md:items-center md:justify-between">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-xl text-gray-300 mb-8 animate-fade-in-up animation-delay-200">
              Securely store, send, and manage your digital assets with ease. Experience the future of payments today.
            </p>
      ...
      <section id="features" className="py-16 md:py-24 bg-gray-900">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12 animate-fade-in-up">Powerful Features for Your Digital Wallet</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Wallet, title: "Multi-Currency Support", description: "Store and manage multiple cryptocurrencies and digital assets in one place." },
              { icon: Shield, title: "Advanced Security", description: "Your digital assets are protected with state-of-the-art encryption and multi-factor authentication." },
              { icon: Smartphone, title: "Mobile-First Design", description: "Access your wallet on-the-go with our intuitive mobile app." },
              { icon: CreditCard, title: "Instant Transactions", description: "Send and receive digital assets quickly and securely." },
              { icon: Users, title: "Peer-to-Peer Transfers", description: "Easily transfer assets to friends and family within the app." },
              { icon: Zap, title: "Real-Time Updates", description: "Get instant notifications and live price updates for your assets." },
            ].map((feature, index) => (
              <Card key={index} className="bg-black hover:bg-gray-800 transition duration-300 animate-fade-in-up" style={{ animationDelay: `${index * 100}ms` }}>
                <div className="p-6">
      ...
      <section id="cta" className="py-16 md:py-24">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-4 animate-fade-in-up">Ready to Join the Digital Revolution?</h2>
          <p className="text-xl text-gray-300 mb-8 animate-fade-in-up animation-delay-200">Join thousands of users who trust our wallet for their digital asset management.</p>
          <button
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Your trusted digital asset companion.</p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-green-400 transition duration-300">Supported Assets</a></li>
              </ul>
            </div>
            <div>
